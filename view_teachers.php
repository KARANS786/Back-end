...
$link = mysqli_connect("localhost", "root", "", "karan");
...
<table>
    ...
    <tr>
        ...
        <th width="250px">TFName<br>
            <hr>
        </th>
        <th width="250px">TLName<br>
            <hr>
        </th>
        <th width="150px">Tnumber<br>
            <hr>
        </th>
        <th width="250px">Temail<br>
            <hr>
        </th>
        <th width="150px">Tsalary<br>
            <hr>
        </th>
        <th width="150px">Bg_check<br>
            <hr>
        </th>
    ...
    /* 	function fetches a result row as an associative array.
        ...
        */
    $sql = mysqli_query($link, "SELECT Tid,TFname,TLname,Tnumber,Temail,Tsalary,Bg_check  FROM teacher");
