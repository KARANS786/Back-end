...
<table>
    ...
    <tr>
        ...
        <th width="150px">phone<br>
            <hr>
        </th>
        <th width="250px">Email<br>
            <hr>
        </th>
        <th width="150px">occupation<br>
            <hr>
        </th>
    ...
    /* 	function fetches a result row as an associative array.
        ...
        */
    $sql = mysqli_query($link, "SELECT Pid,PFname,PLname,Pnumber,Pemail,Poccupation  FROM parents");
